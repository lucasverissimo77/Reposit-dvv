...
def sistema_luz():
    ...
    while 0 < meses_num_py <= 12:
        try:
            meses_num_py = int(input("Insira o mês (1-12) que o senhor quer saber a sua conta ou zero para saber o total\n>  "))
            if meses_num_py == 1:
