...
valores = {
    "Mês Janeiro - R$130.00" : "144.4kWh",
    "Mês Fevereiro - R$130.00" : "144.4kWh",
    "Mês Março - R$120.00" : "133.3kWh",
    "Mês Abril - R$110.00" : "122.2kWh",
    "Mês Maio - R$100.00" : "111.1kWh",
    "Mês Junho - R$95.00" : "105.6kWh",
    "Mês Julho - R$95.00" : "105.6kWh",
    "Mês Agosto - R$100.00" : "111.1kWh",
    "Mês Setembro - R$110.00" : "122.2kWh",
    "Mês Outubro - R$115.00" : "127.8kWh",
    "Mês Novembro - R$120.00" : "133.3kWh",
    "Mês Dezembro -R$125.00" : "138.9kWh",
}
...
def sistema_luz():
    ...
    while 0 < meses_num <= 12:
        try:
            meses_num = int(input("Insira o mês (1-12) que o senhor quer saber a sua conta ou zero para saber o total\n>  "))
            if meses_num == 1:
                ...
                if resposta == "sim":
                    ...
                    print("Opção 5: Sair")
                    opcao = int(input("Digite o número da opção [1-4]"))
                    if opcao == 1:
                ...
                #print("Opção 2: Somar o total de Valores que o0 senhor deve")
